...
if __name__ == '__main__':
    ...
    folder_path = os.path.join(config.MOTIONSCRIPT_REL_PATH + 'tc_cylinder_cad_ik/')
    ...
    mp_lft.ah.show_objmat4(pen_item.objcm, objmat4_final, rgba=(1, 1, 0, .5))
    ...
    # mp_lft.ah.show_objmat4(pen_item.objcm, objmat4_final, rgba=(0, 1, 0, .5))
    # base.run()
    ...
    # mp_x_lft.add_obs(paintingobj_item.objcm)
    ...
    for i in pen_graspidlist_remain:
        ...
        path_picknplace = mp_lft.plan_picknplace(grasp, [objmat4_init, objmat4_final], pen_item.objcm, objrelpos, objrelrot,
        ...
        path_gotodraw = \
            mp_lft.plan_start2end_hold(grasp, [objmat4_final, objmat4_draw_list[0]], pen_item.objcm, objrelpos, objrelrot,
        ...
        if path_draw is None:
            time_cost_dict_mp[i] = {'flag': False, 'flag_draw': False, 'time_cost': time.time() - time_start_tmp,
                                    'time_cost_draw': time.time() - time_start_draw}
            continue

        time_cost_dict_mp[i] = {'flag': False, 'flag_draw': True, 'time_cost': time.time() - time_start_tmp,
                                'time_cost_draw': time.time() - time_start_draw}
