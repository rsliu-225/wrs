...
if __name__ == '__main__':
    ...
    cd = nu.chamfer_distance(objcm.objtrm.vertices, objcm_gt.objtrm.vertices, metric='l2', direction='bi')
    hd = nu.hausdorff_distance(objcm.objtrm.vertices, objcm_gt.objtrm.vertices, metric='l2')
    print(round(cd * 1000, 2), round(hd * 1000, 2))

    objcm.set_rgba((nu.COLOR[0][0], nu.COLOR[0][1], nu.COLOR[0][2], .5))
    objcm.attach_to(base)

    # objcm_kpts.set_rgba((1, 1, 0, .5))
    # objcm_kpts.attach_to(base)

    objcm_gt.set_rgba((nu.COLOR[1][0], nu.COLOR[1][1], nu.COLOR[1][2], .5))
